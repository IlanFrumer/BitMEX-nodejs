...
export declare class BitmexAPI extends BitmexAbstractAPI {
    ...
    APIKey: {
         ...
         */
        new: (formData?: BITMEX.ApiKeyPost) => Promise<BITMEX.APIKey>;
        /**
         * @Authorized
         * Get your API Keys.
         */
         ...
         * Remove an API Key.
         */
        remove: (formData: BITMEX.ApiKeyDelete) => Promise<{
            success: boolean;
        }>;
        /**
         * @Authorized
         * Disable an API Key.
         */
        disable: (formData: BITMEX.ApiKeyDisablePost) => Promise<BITMEX.APIKey>;
        /**
         * @Authorized
         * Enable an API Key.
         */
        enable: (formData: BITMEX.ApiKeyEnablePost) => Promise<BITMEX.APIKey>;
    };
    Chat: {
        /**
         * Get chat messages.
         ...
         * Send a chat message.
         */
        new: (formData: BITMEX.ChatPost) => Promise<BITMEX.Chat>;
        /**
    ...
    Order: {
         ...
         * ```
         */
        new: (formData: BITMEX.OrderPost) => Promise<BITMEX.Order>;
        /**
         * @Authorized
         ...
         */
        amend: (formData?: BITMEX.OrderPut) => Promise<BITMEX.Order>;
        /**
         * @Authorized
         * Cancel order(s). Send multiple order IDs to cancel in bulk.Either an orderID or a clOrdID must be provided.
         */
        cancel: (formData?: BITMEX.OrderDelete) => Promise<BITMEX.Order[]>;
        /**
         * @Authorized
         ...
         */
        newBulk: (formData?: BITMEX.OrderBulkPost) => Promise<BITMEX.Order[]>;
        /**
         * @Authorized
         ...
         * Ratelimited at 10%.
         */
        amendBulk: (formData?: BITMEX.OrderBulkPut) => Promise<BITMEX.Order[]>;
        /**
         * @Authorized
         * Close a position.
         ...
         */
        closePosition: (formData: BITMEX.OrderClosePositionPost) => Promise<BITMEX.Order>;
        /**
         * @Authorized
         * Cancels all of your orders.
         */
        cancelAll: (formData?: BITMEX.OrderAllDelete) => Promise<BITMEX.Order[]>;
        /**
         * @Authorized
         ...
         */
        cancelAllAfter: (formData: BITMEX.OrderCancelAllAfterPost) => Promise<any>;
    };
    OrderBook: {
        /**
    ...
    Position: {
         ...
         */
        isolateMargin: (formData: BITMEX.PositionIsolatePost) => Promise<BITMEX.Position>;
        /**
         * @Authorized
         * Update your risk limit.
         */
        updateRiskLimit: (formData: BITMEX.PositionRiskLimitPost) => Promise<BITMEX.Position>;
        /**
         * @Authorized
         * Transfer equity in or out of a position.
         */
        transferIsolatedMargin: (formData: BITMEX.PositionTransferMarginPost) => Promise<BITMEX.Position>;
        /**
         * @Authorized
         * Choose leverage for a position.
         */
        updateLeverage: (formData: BITMEX.PositionLeveragePost) => Promise<BITMEX.Position>;
    };
    Quote: {
        /**
         * Get Quotes.
    ...
    User: {
         ...
         */
        requestWithdrawal: (formData: BITMEX.UserRequestWithdrawalPost) => Promise<BITMEX.Transaction>;
        /**
         * Cancel a withdrawal.
         */
        cancelWithdrawal: (formData: BITMEX.UserCancelWithdrawalPost) => Promise<BITMEX.Transaction>;
        /**
         * Confirm a withdrawal.
         */
        confirmWithdrawal: (formData: BITMEX.UserConfirmWithdrawalPost) => Promise<BITMEX.Transaction>;
        /**
         * @Authorized
         ...
         */
        requestEnableTFA: (formData?: BITMEX.UserRequestEnableTFAPost) => Promise<boolean>;
        /**
         * @Authorized
         * Confirm two-factor auth for this account.
         * If using a Yubikey, simply send a token to this endpoint.
         */
        confirmEnableTFA: (formData: BITMEX.UserConfirmEnableTFAPost) => Promise<boolean>;
        /**
         * @Authorized
         * Disable two-factor auth for this account.
         */
        disableTFA: (formData: BITMEX.UserDisableTFAPost) => Promise<boolean>;
        /**
         * Confirm your email address with a token.
         */
        confirm: (formData: BITMEX.UserConfirmEmailPost) => Promise<BITMEX.AccessToken>;
        /**
         * @Authorized
         ...
         */
        savePreferences: (formData: BITMEX.UserPreferencesPost) => Promise<BITMEX.User>;
        /**
         * @Authorized
         * Get your user model.
         */
         ...
         */
        update: (formData?: BITMEX.UserPut) => Promise<BITMEX.User>;
        /**
         * @Authorized
         * Get your account's commission status.
         */
        getCommission: () => Promise<BITMEX.UserCommission[]>;
        /**
         * @Authorized
